;(function() {
    ...
    fa.type = "text/css"
    fa.textContent = '@font-face { font-family: Roboto; src: url("' + chrome.extension.getURL("css/Roboto-Regular.ttf") + '"); }'
...
function doHighlight(bodyText, searchTerm, highlightStartTag, highlightEndTag) {
    ...
    if (!highlightStartTag || !highlightEndTag) {
        highlightStartTag = "<font style='color:blue; background-color:yellow;' class='black-box-found-text'>"
...
chrome.runtime.onMessage.addListener((req,sender,res)=>{
    if (req.message === "search") {
        ...
        $(".black-box-search-page-holder .search-middle .search-result-items").empty()
        $(".black-box-search-page-holder .search-top .black-box-loader").css("visibility", "hidden")
        ...
        data.forEach((result)=>{
            ...
            if (result.length != 0) {
				...
				`)
                $(".black-box-search-page-holder .search-middle .search-result-items").append($el)
            }
        }
        )
    }
...
function openSearch(req) {
    if ($(`.black-box-search-page-holder`).length === 0) {
        ...
        $(document).on("click", ".black-box-search-page-holder .search-item", function() {
        ...
        chrome.storage.local.get(["searched"], function(items) {
            if (items.searched !== undefined) {
                ...
                arr.forEach((el)=>{
                    $(".black-box-search-page-holder .search-middle .search-result-items").append($.parseHTML(el))
                }
                )
            } else {
                $(".black-box-search-page-holder .search-middle").addClass("hide")
            }
        })
        $(".black-box-search-page-holder .search-input").on("keydown", function(e) {
...
function searchQuery(query, from="") {
    $(".black-box-search-page-holder .search-top .black-box-loader").css("visibility", "visible")
    if (!query) {
        query = savedTerm
    }
