!function() {
    ...
    Vue.createApp({
        ...
        data: ()=>({
            ...
            itemsPerPage: 7,
            filters: ["All", "HTML", "React.js", "Next.js"],
            currentFilter: "All",
            portfolioArchiveName: "",
            allPortfolioItems: [{
                id: 1,
                url: "single-portfolio.html?id=1",
                imgUrl: "img/single-portfolio-5.png",
                title: {
            ...
            testimonialsItems: [{
                ...
                imgUrl: "img/testimonials-1.jpg",
                quoteContent: {
                    en: "Excellent Team to work with. Always positive to find the most appropriate solution. Haris is one of the professional web development agency that provides awesome services.",
                ...
                imgUrl: "img/testimonials-5.jpg",
                quoteContent: {
                    en: "Haris team is very professional, always delivers high quality results, and is always there to help. Look forward to working with Harisin other projects.",
                ...
                imgUrl: "img/testimonials-13.jpg",
                quoteContent: {
                ...
                imgUrl: "img/testimonials-17.jpg",
                quoteContent: {
                    en: "Haris was a real pleasure to work with and we look forward to working with him again. He’s definitely the kind of developer you can trust with a project from start to finish.",
                    ar: "أنا سعيد حقًا بالعمل مع محمد وأتطلع إلى العمل معه مرة أخرى قريبا. هو بالتأكيد من المطورين الذي يمكنك الوثوق بهم للعمل على مشروعك من البداية إلى النهاية."
                },
                ...
                imgUrl: "img/testimonials-18.jpg",
                quoteContent: {
                    en: "I know I can count on your service if I need my project done fast and with the best possible result. I am a regular customer and hope to continue our work!",
                    ar: "يمكنني الاعتماد على خدمات محمد دائمًا وخاصة إذا كنت بحاجة إلى إنجاز مشروعي في أقل وقت وبأفضل نتيجة ممكنة. أنا عميل منتظم لديه وآمل أن نواصل عملنا معا دائمًا."
                },
                ...
                imgUrl: "img/testimonials-10.jpg",
                quoteContent: {
                ...
                imgUrl: "img/testimonials-12.jpg",
                quoteContent: {
                    en: "Excellent Team to work with. Always positive to find the most appropriate solution. Haris is one of the professional web development agency that provides awesome services.",
                    ar: "فريق ممتاز للعمل معه. إيجابي دائمًا للعثور على الحل الأنسب. هم إحدى شركات تطوير الويب المحترفة التي تقدم خدمات رائعة."
                },
